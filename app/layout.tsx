...
export const metadata = {
  title: {
    default: "TechClan - Data Science Community",
    template: "%s | TechClan",
  },
  description: "Join TechClan - A modern community for Data Science enthusiasts. Learn, build, and collaborate on real projects.",
  icons: {
